    ...
    <div id="hd_wrapper">
        ...
        <nav id="gnb">
          ...
          <div class="gnb_wrap">
              ...
              <div class="util">
                <button type="button" class="gnb_btn gnb_search_btn" title="검색"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색</span></button>
                <button type="button" class="gnb_btn gnb_menu_btn" title="전체메뉴"><i class="fa fa-bars" aria-hidden="true"></i><span class="sound_only">전체메뉴열기</span></button>
              </div>
