...
define('G5_MYSQL_USER', 'h4hm');
define('G5_MYSQL_PASSWORD', 'H!dbwjd7101');
define('G5_MYSQL_DB', 'h4hm');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '93ced3ee27b386949f905c59fadce9b4'); // 토큰 암호화에 사용할 키
