...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
...
if (defined('G5_IS_ADMIN')) {
    ...
    // echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/'.(G5_IS_MOBILE?'mobile':'default').$shop_css.'.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
     echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/default.css"> <link rel="stylesheet" href="/work/jei/dist/css/comm.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
}
?>
...
add_javascript('<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/ScrollTrigger.min.js"></script>', 0);
// slider
add_javascript('<script src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>', 0);
add_javascript('<script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>', 0);

add_javascript('<script src=/work/jei/dist/js/comm.js"></script>', 0);
...
// add_stylesheet('<link rel="stylesheet" href="/work/jei/dist/css/comm.css">', 0);
...
?>
<!-- <link rel="stylesheet" href="/work/jei/dist/css/comm.css" /> -->
</head>
